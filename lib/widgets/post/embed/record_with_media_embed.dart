...
class RecordWithMediaEmbed extends StatelessWidget {
  final bsky.EmbedViewRecordWithMedia data;

  const RecordWithMediaEmbed({Key? key, required this.data}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    final recData = data.record.toJson();
