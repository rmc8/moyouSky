...
class UserProfileState extends State<UserProfile>
  ...
  List<Widget> _authorFeeds() {
    return [
      AuthorFeedView(feedFetcher: PostFetcher(actor: widget.did)),
      AuthorFeedView(feedFetcher: ReplyFetcher(actor: widget.did)),
      AuthorFeedView(feedFetcher: MediaPostFetcher(actor: widget.did)),
      AuthorFeedView(feedFetcher: LikeFetcher(actor: widget.did)),
    ];
  }

  BskyBottomNavigationBar _bottomNavigationBar() {
